      ...
      <div className="about-wrap">
        <div className="about-content">
          ...
          <p className="about-paragraph">
            ...
            development. Ian takes pride in being a dedicated and reliable team player, who thrives in collaborative environments and has a strong will to discover the best solution to the problem being faced. Over the past year, Ian has built a variety of projects both individually and within teams, working with developers across various disciplines.
          </p>
        </div>
